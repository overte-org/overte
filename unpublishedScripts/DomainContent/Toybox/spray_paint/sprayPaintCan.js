...
(function () {
 Script.include("../libraries/utils.js");
    ...
    this.spraySound = SoundCache.getSound("https://hifi-content/DomainContent/Toybox/spray_paint/spray_paint.wav");
    ...
    this.enableStream = function () {
        ...
        this.paintStream = Entities.addEntity({
            ...
            isEmitting: true,
            position: position,
            textures: "https://hifi-content/DomainContent/Toybox/spray_paint/smokeparticle.png",
            emitSpeed: 3,
            speedSpread: 0.02,
