...
(function() {
    ...
    function Avatar(DEFAULT_X, DEFAULT_Y, rotation, to3DPosition) {
        ...
        var airSwipeSound = SoundCache.getSound("https://hifi-content/DomainContent/Toybox/flappyAvatars/Air%20Swipe%2005.wav");
        var injector = null;
        ...
        var id = entityManager.add({
            ...
            animation: {
                url: "https://hifi-content/DomainContent/Toybox/flappyAvatars/fly.fbx",
                running: true,
                fps: 30,
                firstFrame: 1.0,
                lastFrame: 80.0,
        ...
        this.changeModel = function(modelURL) {
            ...
            airSwipeSound = SoundCache.getSound("https://hifi-content/DomainContent/Toybox/flappyAvatars/8bit%20Jump%2003.wav");
            injector = null;
        }
    ...
    function Coin(xPosition, yPosition, to3DPosition) {
        ...
        var id = entityManager.add({
            type: "Model",
            modelURL: "https://hifi-content/DomainContent/Toybox/flappyAvatars/coin.fbx",
    ...
    function Pipe(xPosition, yPosition, height, gap, to3DPosition) {
        ...
        var idUp = entityManager.add({
            type: "Model",
            modelURL: "https://hifi-content/DomainContent/Toybox/flappyAvatars/greenPipe.fbx",
    ...
    function Pipes(newPipesPosition, newPipesHeight, to3DPosition, moveScore) {
        ...
        var coinsSound = SoundCache.getSound("https://hifi-content/DomainContent/Toybox/flappyAvatars/Coin.wav");
        var injector = null;
    ...
    function Score(space, bestScore) {
        ...
        function numberUrl(number) {
            return "https://hifi-content/DomainContent/Toybox/flappyAvatars/" + number + ".fbx"
        }
        ...
        var bestId = entityManager.add({
            type: "Model",
            modelURL: "https://hifi-content/DomainContent/Toybox/flappyAvatars/best.fbx",
            position: topLeft,
        ...
        var scoreId =  entityManager.add({
            type: "Model",
            modelURL: "https://hifi-content/DomainContent/Toybox/flappyAvatars/score.fbx",
            position: bottomLeft,
            rotation: Quat.multiply(space.orientation, Quat.fromPitchYawRollDegrees(90, 0, 0)),
    ...
    function Game(bestScore) {
        ...
        var gameOverSound = SoundCache.getSound("https://hifi-content/DomainContent/Toybox/flappyAvatars/Game%20Over.wav");
        var injector = null;
        ...
        function keyPress(event) {
            ...
            if (current === sequence.length) {
                avatar.changeModel("https://hifi-content/DomainContent/Toybox/flappyAvatars/mario.fbx");
                current = 0;
            }
        }
