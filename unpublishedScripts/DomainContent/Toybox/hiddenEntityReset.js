...
(function() {
    ...
    PrimaryReset = function() {
        ...
        function createRaveStick(position) {
            var modelURL = "https://hifi-content/DomainContent/Toybox/flowArts/raveStick.fbx";
            ...
            var raveGlowEmitter = Entities.addEntity({
                ...
                alphaStart: 0.1,
                alphaFinish: 0.1,
                textures: "https://hifi-content/DomainContent/Toybox/flowArts/beamParticle.png",
        ...
        function createGun(position) {
            var modelURL = "https://hifi-content/DomainContent/Toybox/pistol/gun.fbx";
            ...
            var pistol = Entities.addEntity({
                ...
                restitution: 0,
                damping: 0.5,
                collisionSoundURL: "https://content.overte.org/DomainContent/Toybox/pistol/drop.wav",
                dimensions: {
                    x: 0.05,
                    y: 0.23,
                    z: 0.36
        ...
        function createFire() {
            ...
            var fire = Entities.addEntity({
                ...
                textures: "https://hifi-content/DomainContent/Toybox/fire/Particle-Sprite-Smoke-1.png",
                position: {
                    x: 551.45,
                    y: 494.82,
                    z: 502.05
        ...
        function createBasketballRack() {
            ...
            var basketballCollisionSoundURL = "https://hifi-content/DomainContent/Toybox/basketball/basketball.wav";
            ...
            function createCollidingBalls() {
                ...
                for (i = 0; i < NUMBER_OF_BALLS; i++) {
                    ...
                    var collidingBall = Entities.addEntity({
                        ...
                        dynamic: true,
                        collisionSoundURL: 'https://hifi-content/DomainContent/Toybox/basketball/basketball.wav',
                        collisionless: false,
        ...
        function createCat(position) {
            ...
            var modelURL = "https://hifi-content/DomainContent/Toybox/cat/Dark_Cat.fbx";
            var animationURL = "https://hifi-content/DomainContent/Toybox/cat/sleeping.fbx";
            var animationSettings = JSON.stringify({
                running: true
            });
        ...
        function createFlashlight(position) {
            var modelURL = "https://hifi-content/DomainContent/Toybox/flashlight/flashlight.fbx";
            ...
            var flashlight = Entities.addEntity({
                ...
                dynamic: true,
                collisionSoundURL: "https://hifi-content/DomainContent/Toybox/flashlight/flashlight_drop.L.wav",
                gravity: {
                    x: 0,
                    y: -3.5,
                    z: 0
        ...
        function createLights() {
            var modelURL = "https://hifi-content/DomainContent/Toybox/lights/lightswitch.fbx";
        ...
        function createDice() {
            var diceProps = {
                type: "Model",
                modelURL: "https://hifi-content/DomainContent/Toybox/dice/goldDie.fbx",
                collisionSoundURL: "https://hifi-content/DomainContent/Toybox/dice/diceCollide.wav",
                name: "dice",
                position: {
                    x: 541.61,
                    y: 495.21,
        ...
        function createGates() {
            var MODEL_URL = 'https://hifi-content/DomainContent/Toybox/gates/fence.fbx';
        ...
        function createWand(position) {
            var WAND_MODEL = 'https://hifi-content/DomainContent/Toybox/bubblewand/wand.fbx';
            var WAND_COLLISION_SHAPE = 'https://hifi-content/DomainContent/Toybox/bubblewand/wand_collision_hull.obj';
        ...
        function createBasketBall(position) {
            ...
            var modelURL = "https://hifi-content/DomainContent/Toybox/basketball/basketball2.fbx";
        ...
        function createDoll(position) {
            var modelURL = "https://hifi-content/DomainContent/Toybox/doll/bboy2.fbx";
        ...
        function createSprayCan(position) {
            ...
            var modelURL = "https://hifi-content/DomainContent/Toybox/spray_paint/paintcan.fbx";
            ...
            var entity = Entities.addEntity({
                ...
                dynamic: true,
                collisionSoundURL: "https://hifi-content/DomainContent/Toybox/spray_paint/SpryPntCnDrp1.L.wav",
                shapeType: 'box',
                restitution: 0,
                gravity: {
                    x: 0,
        ...
        function createPottedPlant(position) {
            var modelURL = "https://hifi-content/DomainContent/Toybox/potted_plant/potted_plant.fbx";
        ...
        function createCombinedArmChair(position) {
            var modelURL = "https://hifi-content/DomainContent/Toybox/armchair/combined_chair.fbx";
            var RED_ARM_CHAIR_COLLISION_HULL = "https://hifi-content/DomainContent/Toybox/armchair/red_arm_chair_collision_hull.obj";
        ...
        function createBlocks(position) {
            var baseURL = "https://hifi-content/DomainContent/Toybox/planky/";
            var collisionSoundURL = "https://hifi-content/DomainContent/Toybox/planky/ToyWoodBlock.L.wav";
