...
(function() {
    ...
    var Doll = function() {
        _this = this;
        this.screamSounds = [SoundCache.getSound("https://hifi-content/DomainContent/Toybox/doll/KenDoll_1%2303.wav")];
    };
    ...
    Doll.prototype = {
        ...
        startNearGrab: function(entityID, args) {
            ...
            Entities.editEntity(this.entityID, {
                animation: {
                    url: "https://hifi-content/DomainContent/Toybox/doll/zombie_scream.fbx",
                    running: true
                }
            });
