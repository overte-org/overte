...
protected:
     ...
     * }
     */
    Q_INVOKABLE ScriptAudioInjector* playSound(std::shared_ptr<Sound> sound, const AudioInjectorOptions& injectorOptions = AudioInjectorOptions());
     ...
     * @returns {AudioInjector} The audio injector that plays the audio file.
     */
    Q_INVOKABLE ScriptAudioInjector* playSystemSound(std::shared_ptr<Sound> sound);
