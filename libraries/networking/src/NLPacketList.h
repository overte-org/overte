...
public:
    ...
    static std::unique_ptr<NLPacketList> createCopy(const NLPacketList& other);
    ...
    const std::list<udt::PacketList::PacketPointer>& getPackets() const { return _packets; }
...
private:
    ...
    NLPacketList(const NLPacketList& packetList);
