...
public: // implementation of CongestionControl
    ...
    virtual void onPacketReceived(CongestionControlParms& parms, const Packet& packet, const QElapsedTimer& timeReceived);        // data is received
	virtual void onCustomMessageReceived(CongestionControlParms& parms, const Packet& packet, const QElapsedTimer& timeReceived); // user-defined packet is received
