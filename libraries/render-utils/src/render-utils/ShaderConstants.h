...
#define RENDER_UTILS_ATTR_FADE4 14
#define RENDER_UTILS_ATTR_FADE5 15
#define RENDER_UTILS_ATTR_FADE6 16
#define RENDER_UTILS_ATTR_FADE7 17

// don't conflict with GPU_ATTR_V2F_STEREO_SIDE in the GPU shader constants
#define RENDER_UTILS_ATTR_DO_NOT_USE 18
// don't conflict with GPU_ATTR_V2F_DRAW_CALL_INFO in the GPU shader constants
#define RENDER_UTILS_ATTR_DO_NOT_USE2 19
...
// Fading
#define RENDER_UTILS_BUFFER_FADE_OBJECT_PARAMS 9 // this can overlap RENDER_UTILS_BUFFER_LIGHT_INDEX because they aren't used at the same time
...
#define RENDER_UTILS_BUFFER_SHADOW_PARAMS 9
