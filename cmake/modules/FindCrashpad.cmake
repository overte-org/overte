...
find_library(CRASHPAD_HANDLER_LIBRARY_RELEASE handler PATH_SUFFIXES "Release_x64/lib_MD" HINTS ${CRASHPAD_SEARCH_DIRS})
find_library(CRASHPAD_COMMON_LIBRARY_RELEASE common PATH_SUFFIXES "Release_x64/lib_MD" HINTS ${CRASHPAD_SEARCH_DIRS})
...
find_library(CRASHPAD_HANDLER_LIBRARY_DEBUG handler PATH_SUFFIXES "Debug_x64/lib_MD" HINTS ${CRASHPAD_SEARCH_DIRS})
find_library(CRASHPAD_COMMON_LIBRARY_DEBUG common PATH_SUFFIXES "Debug_x64/lib_MD" HINTS ${CRASHPAD_SEARCH_DIRS})
...
select_library_configurations(CRASHPAD_HANDLER)
select_library_configurations(CRASHPAD_COMMON)



include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(Crashpad DEFAULT_MSG CRASHPAD_INCLUDE_DIRS CRASHPAD_LIBRARY CRASHPAD_BASE_LIBRARY CRASHPAD_UTIL_LIBRARY CRASHPAD_HANDLER_LIBRARY CRASHPAD_COMMON_LIBRARY)
