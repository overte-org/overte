...
macro(GENERATE_ENTITY_PROPERTIES)
    ...
    while(ENTITY_PROPERTIES_FILE)
        ...
        elseif(LINE MATCHES "group:.*,")
            ...
            if(NOT COMMON_PROPS)
                string(CONCAT ENTITY_ITEM_PROPERTY_COPY_TO_SCRIPT "${ENTITY_ITEM_PROPERTY_COPY_TO_SCRIPT}" "\t_${ENTITY_PROPERTY_GROUP}.copyToScriptValue(_desiredProperties, properties, engine, skipDefaults, defaultEntityProperties, returnNothingOnEmptyPropertyFlags, ownership);\n")
