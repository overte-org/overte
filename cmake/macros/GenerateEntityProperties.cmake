...
macro(GENERATE_ENTITY_PROPERTIES)
    ...
    while(ENTITY_PROPERTIES_FILE)
        ...
        elseif(LINE MATCHES "group:.*,")
            ...
            string(REGEX MATCH ".*types:+([A-Z0-9a-z_<>::\/\.\"\(\)\+]+)( |,)" ENTITY_PROPERTY_TYPES ${LINE})
            set(ENTITY_PROPERTY_TYPES ${CMAKE_MATCH_1})
    ...
    while(GROUP_PROPERTIES_FILE)
        ...
        if(NOT LINE MATCHES ".*,")
            ...
            string(REGEX MATCH ".*types:+([A-Z0-9a-z_<>::\/\.\"\(\)\+]+)( |,)" GROUP_PROPERTY_TYPES ${LINE})
            set(GROUP_PROPERTY_TYPES ${CMAKE_MATCH_1})
