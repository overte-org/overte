...
if(WIN32)
    ...
    if(VIRCADIA_OPTIMIZE)
        set(OVERTE_OPUS_BUILD_TYPE "-DCMAKE_BUILD_TYPE=Release")
    else()
        set(OVERTE_OPUS_BUILD_TYPE "-DCMAKE_BUILD_TYPE=RelWithDebInfo")
    endif()

    if(DEFINED VIRCADIA_CPU_ARCHITECTURE)
        set(OVERTE_OPUS_CXX_FLAGS "-DCMAKE_CXX_FLAGS=${VIRCADIA_CPU_ARCHITECTURE}")
        set(OVERTE_OPUS_C_FLAGS "-DCMAKE_C_FLAGS=${VIRCADIA_CPU_ARCHITECTURE}")
    endif()
endif()

message("Optimization options for Opus: ${OVERTE_OPUS_BUILD_TYPE} ${OVERTE_OPUS_CXX_FLAGS} ${OVERTE_OPUS_C_FLAGS}")

vcpkg_configure_cmake(
    SOURCE_PATH ${SOURCE_PATH}
    PREFER_NINJA
    OPTIONS
        ${OVERTE_OPUS_BUILD_TYPE}
        ${OVERTE_OPUS_CXX_FLAGS}
        ${OVERTE_OPUS_C_FLAGS}
)
