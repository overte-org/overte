...
if(WIN32)
    ...
    if(VIRCADIA_OPTIMIZE)
        set(OVERTE_BULLET_BUILD_TYPE "-DCMAKE_BUILD_TYPE=Release")
    else()
        set(OVERTE_BULLET_BUILD_TYPE "-DCMAKE_BUILD_TYPE=RelWithDebInfo")
    endif()

    if(DEFINED VIRCADIA_CPU_ARCHITECTURE)
        set(OVERTE_BULLET_CXX_FLAGS "-DCMAKE_CXX_FLAGS=${VIRCADIA_CPU_ARCHITECTURE}")
        set(OVERTE_BULLET_C_FLAGS "-DCMAKE_C_FLAGS=${VIRCADIA_CPU_ARCHITECTURE}")
    endif()
endif()

message("Optimization options for Bullet: ${OVERTE_BULLET_BUILD_TYPE} ${OVERTE_BULLET_CXX_FLAGS} ${OVERTE_BULLET_C_FLAGS}")
...
vcpkg_configure_cmake(
    ...
    OPTIONS
        ...
        -DINSTALL_LIBS=ON
        ${OVERTE_BULLET_BUILD_TYPE}
        ${OVERTE_BULLET_CXX_FLAGS}
        ${OVERTE_BULLET_C_FLAGS}
